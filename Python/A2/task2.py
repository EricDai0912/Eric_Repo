"""
This is a program that allows a user to create and store new rabbytes. Each rabbit is identified by a unique name, allows the user to enter a rabbit's age and allows the user to specify a parent/kitten relationship.
"""
